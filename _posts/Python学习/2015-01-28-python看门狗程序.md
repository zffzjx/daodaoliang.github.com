...
check_My_server_command = "/etc/init.d/My-server status"
# when server stopped, restart it.
start_My_server_command = "/etc/init.d/My-server start"
...
# consts
My_server_dir = "/usr/local/My-server"
My_server_version_command = "%s/objs/My_server" % My_server_dir
My_server_conf_file = "%s/conf/My_server.conf" % My_server_dir
My_server_log_prefix = "mylog_server_system"
